					...
					>
						...
						{result ? ( 
							...
							<>
								...
								>
									<h2
										className="text-white fw-bold font-size-xxl"
										style={{
									...
									<p className="text-white ">Upload your car images and get instant AI-powered damage assessment</p>
								</div>
								{/* Show car icon if no result */}
